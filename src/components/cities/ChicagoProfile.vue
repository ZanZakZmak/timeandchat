<template>
  <div class="chicagoprofile" style="padding: 30px">
    <div class="col-3 float-left pr-3">
      <img alt="" class="chicago" src="chicago.jpg" style="border-radius: 10%; height: 300px; width: 300px"> 
      <h3>Chicago</h3>
      <h6>Country: United States of America</h6>
      <br>
      <h6>Location: 41.8781° N, 87.6298° W </h6>
      <br>
      <h6>Time zone: CST</h6>
      <br>
    ...
    <div class="col-9 float-left pl-2">
      <p style="float: left; padding: 40px font-size: 15px">
        ...
        With an estimated population of 2,705,994 (2018), it is also the most populous city in the Midwestern United States.
        ...
        It is the site of the creation of the first standardized futures contracts, issued by the Chicago Board of Trade, which today is the largest and most diverse derivatives market in the world, generating 20% of all volume in commodities and financial futures alone.
        Chicago was listed as an alpha global city by the Globalization and World Cities Research Network, and it ranked seventh in the entire world in the 2017 Global Cities Index.
        Chicago's 58 million domestic and international visitors in 2018 made it the second most visited city in the nation, as compared with New York City's 65 million visitors in 2018.
        The city was ranked first in the 2018 Time Out City Life Index, a global quality of life survey of 15,000 people in 32 cities.
