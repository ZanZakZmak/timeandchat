<template>
  <div class="amsterdamprofile" style="padding: 30px">
    <div class="col-3 float-left pr-3">
      <img alt="" class="amsterdam" src="amsterdam.jpg" style="border-radius: 10%; height: 300px; width: 300px"> 
      <h3>Amsterdam</h3>
      <h6>Country: Netherlands</h6>
      <br>
      <h6>Location: 52.3667° N, 4.8945° E </h6>
      <br>
      <h6>Time zone: CET</h6>
      <br>
    ...
    <div class="col-9 float-left pl-2">
      <p style="float: left; padding: 40px font-size: 15px">
        ...
        Many of the world's largest companies are based in Amsterdam or have established their European headquarters in the city, such as leading technology companies Uber, Netflix and Tesla.
