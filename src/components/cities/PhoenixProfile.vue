<template>
  <div class="phoenixprofile" style="padding: 30px">
    <div class="col-3 float-left pr-3">
      <img alt="" class="phoenix" src="phoenix.jpg" style="border-radius: 10%; height: 300px; width: 300px">
      <h3>Phoenix</h3>
